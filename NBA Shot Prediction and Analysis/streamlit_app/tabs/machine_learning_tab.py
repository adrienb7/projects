...
models_general = {
    ...
    "Gradient Boosting Classifier": joblib.load('gradient_boosting_classifier.joblib'),
...
- Gradient boosting type models achieved the highest accuracy, reaching over 64%.
- Trained XGBoost model on specific players, achieving nearly 69% accuracy, a significant gain.
""")
 ...
 # Choix du modèle général
    ...
    st.markdown('<p style="color: #17408b; font-size: 27px; font-style: italic; font-weight: 600;">Model Parameters</p>', unsafe_allow_html=True)
    st.write(model_general.get_params())
    st.markdown('<p style="color: #17408b; font-size: 27px; font-style: italic; font-weight: 600;">Accuracy</p>', unsafe_allow_html=True)
    st.write(f"**{accuracies[model_name_general]*100:.2f}%**")
    st.markdown('<p style="color: #17408b; font-size: 27px; font-style: italic; font-weight: 600;">Classification Report</p>', unsafe_allow_html=True)
    st.table(classification_reports[model_name_general])
    # Matrice de confusion
    st.markdown('<p style="color: #17408b; font-size: 27px; font-style: italic; font-weight: 600;">Confusion Matrix</p>', unsafe_allow_html=True)
    ...
    if model_name_general == "Gradient Boosting Classifier":
        st.markdown('<p style="color: #17408b; font-size: 27px; font-style: italic; font-weight: 600;">Features importance</p>', unsafe_allow_html=True)
    ...
    st.write("## Model trained on a single player")
